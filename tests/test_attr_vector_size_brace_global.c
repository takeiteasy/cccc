...
int main(void) {
    if (g[0] != 1.0f) return 1;
    if (g[1] != 2.0f) return 2;
    if (g[2] != 3.0f) return 3;
    if (g[3] != 4.0f) return 4;
    ...
    if (g_partial[0] != 7.0f) return 9;
    if (g_partial[1] != 0.0f) return 10;
    if (g_partial[2] != 0.0f) return 11;
    if (g_partial[3] != 0.0f) return 12;
