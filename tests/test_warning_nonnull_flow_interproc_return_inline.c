...
// with 'returns_nonnull' Follow-up to #688 (#690): a bare call used directly as
// the return expression (not first assigned to a local) now also feeds NN_MAYBE
// via nn_state_of_expr() in nn_check_return().
