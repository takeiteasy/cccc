...
// \(parameter 1\) Follow-up to #688/#690/#693 (#692): always_null() has no
// non-null return path at all -- every reachable return is a literal null -- so
// the whole-TU summary now flags it always_returns_null, and nn_state_of_expr()
