...
[[cccc::comptime]]
Node *ninth_arg(Node *a0, Node *a1, Node *a2, Node *a3, Node *a4, Node *a5,
                Node *a6, Node *a7, Node *a8) {
    return a8;
}

[[cccc::comptime]]
Node *fixed9_plus_tail(Node *a0, Node *a1, Node *a2, Node *a3, Node *a4,
                       Node *a5, Node *a6, Node *a7, Node *a8, ...) {
