...
int main(void) {
    ...
    if (i[0] != 1) return 1;   // truncates toward zero, not round
    if (i[1] != -1) return 2;
    if (i[2] != 2) return 3;
    if (i[3] != -2) return 4;
    ...
    if (f2[0] != 1.0f) return 5;
    if (f2[1] != -1.0f) return 6;
    if (f2[2] != 100.0f) return 7;
    if (f2[3] != -100.0f) return 8;
    ...
    if (d2[0] != 7.0) return 11;
    if (d2[1] != -7.0) return 12;
