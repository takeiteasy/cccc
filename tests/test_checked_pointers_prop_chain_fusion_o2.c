...
// + one -f pass. #941's chained propagation adds a codegen shape #919's own
// fusion tests (test_checked_pointers_prop_fusion_o2.c) never exercised: a
// chained candidate's snapshot store is a hidden-temp-to-hidden-temp pointer
// copy
