...
// Consolidated suite: C89 with pedantic warnings — C99 extensions warn but
// compile Source tests: test_pedantic_long_long_warning,
// test_std_c89_compound_literal_error,
//               test_std_c89_designated_init_error,
//               test_std_c89_line_comment_error, test_std_c89_mixed_decl_error,
//               test_std_c89_vla_error
//
...
// test_pedantic_long_long_warning: 'long long' warns in pedantic C89 but is
// allowed
[[cccc::test(return = 42)]]
...
// test_std_c89_designated_init_error: designated initializers warn in pedantic
// C89
[[cccc::test(return = 42)]]
