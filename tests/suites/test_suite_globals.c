...
// Source tests: test_extern_comprehensive1, test_extern_file2,
// test_extern_simple1, test_extern_works, test_global_pointer_init,
// test_globals, test_globals_comprehensive, test_globals_simple, test_static,
...
static int test_uninit() {
    ...
    if (tc_globals_comprehensive_uninit_global != 0)
        return 1;
    if (uninit_char != 0)
        return 2;
    ...
    // Read back
    if (tc_globals_comprehensive_uninit_global != 50)
        return 3;
    if (uninit_char != 'Y')
        return 4;
...
static int outer() {
    static int x = 0;
    x            = x + 1;
    return x + _static_comprehensive_counter(); // _static_comprehensive_counter
                                                // has its own static
}
...
int test_globals_comprehensive(void) {
    ...
    if (read_global_int() != 100)
        errors++;

    // Test 2: Write and read back
    write_global_int(150);
    if (read_global_int() != 150)
        errors++;
    ...
    if (test_global_array() != 0)
        errors++;

    // Test 6: Pointers to globals
    if (test_global_pointer() != 0)
        errors++;
...
int test_static_comprehensive(void) {
    ...
    if (_static_comprehensive_counter() != 1)
        return 4;
    if (_static_comprehensive_counter() != 2)
        return 5;
    if (_static_comprehensive_counter() != 3)
        return 6;
