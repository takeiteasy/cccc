...
static [[gnu::const]] static int triple(int x) { return x * 3; }

// [[gnu::pure]] annotated function

static [[gnu::pure]]  static int double_it(int x) { return x * 2; }
...
static [[gnu::const]] static int square(int x) { return x * x; }

static [[gnu::const]] static int add2(int x, int y) { return x + y; }
...
static inline int _inline_singlereturn_max(int a, int b) { return a < b ? b : a; }
...
static __attribute__((pure)) int pure_fn(int x) { return x * 2; }

static __attribute__((const)) int const_fn(int x) { return x + 1; }
...
static [[gnu::pure]] int gnu_pure(int x) { return x + 10; }

static [[gnu::const]] int gnu_const(int x) { return x * 3; }
...
static __attribute__((pure)) int _pure_dead_call_elim_square(int x) { return x * x; }

static __attribute__((const)) int cube(int x) { return x * x * x; }
...
// test_inline_dead
[[cccc::test(return = 42)]]
int test_inline_dead(void) { return 42; }
...
int test_inline_singlereturn(void) {
    ...
    if (_inline_singlereturn_max(15, 30) != 30) return 2;
    if (add(add(5, 3), 2) != 10) return 3;
    if (_inline_singlereturn_clamp(5, 10, 20) != 10) return 4;
    if (_inline_singlereturn_clamp(25, 10, 20) != 20) return 5;
    if (_inline_singlereturn_clamp(15, 10, 20) != 15) return 6;
    return 42;
}
...
int test_pure_dead_call_elim(void) {
    ...
    if (_pure_dead_call_elim_square(4) != 16) return 3;
