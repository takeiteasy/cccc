...
// Source tests: test_array_decay, test_array_decay_params,
// test_array_no_return, test_compound_arrays, test_global_array_direct,
// test_global_array_indices, test_global_array_minimal,
// test_global_array_return, test_global_arrays, test_multidim_comprehensive,
// test_static_array_param, test_zero_length_arrays
...
int test_array_decay_params(void) {
    ...
    if (ptr[0] != 20)
        return 11;      // ptr[0] is test_arr[1]
    if (ptr[1] != 5)
        return 12;      // ptr[1] is test_arr[2]
...
int test_array_no_return(void) {
    ...
    arr5[0]   = 10;
    arr5[1]   = 32;
    if (tc_array_no_return_global_array[0] != 10)
        return 17;
    if (tc_array_no_return_global_array[1] != 32)
        return 18;
...
int test_global_arrays(void) {
    ...
    if (tc_global_arrays_global_array[0] != 10)
        return 1;
    if (tc_global_arrays_global_array[1] != 20)
        return 2;
    if (tc_global_arrays_global_array[4] != 50)
        return 3;

    // Test modifying array elements
    tc_global_arrays_global_array[2] = 99;
    if (tc_global_arrays_global_array[2] != 99)
        return 4;
...
[[cccc::test(return = 42)]]
int test_static_array_param(void) {
    return 42;
}
...
// test_array_partial_init: partial initialization; remaining elements
// zero-filled
[[cccc::test(return = 42)]]
