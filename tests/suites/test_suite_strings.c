...
// Source tests: test_string_concat, test_string_functions, test_strings,
// test_strings_and_arrays, test_strings_comprehensive, test_unicode_comments,
...
// Format string validation: valid printf/sprintf calls with
