...
int test_decimal_sizes(void) {
    ...
    if (sizeof(_Decimal128) != 16)
        return 3;
    if (_Alignof(_Decimal32) != 4)
        return 4;
    if (_Alignof(_Decimal64) != 8)
        return 5;
    if (_Alignof(_Decimal128) != 16)
        return 6;
    ...
    if (sizeof(struct S32) != 8)
        return 10;
    if (sizeof(struct S64) != 16)
        return 11;
    if (sizeof(struct S128) != 32)
        return 12;
...
int test_decimal_arithmetic_d64(void) {
    ...
    if (0.1dd + 0.2dd != 0.3dd)
        return 2; // exact under BID; false for binary FP
...
int test_decimal_conversions(void) {
    ...
    if ((int)d != 7)
        return 2;
    if ((int)3.9dd != 3)
        return 3; // truncating, not rounding
    if ((int)(-3.9dd) != -3)
        return 4;
...
int test_decimal_struct_array(void) {
    ...
    if (prices[0] + prices[1] + prices[2] != 6.dd)
        return 3;
    ...
    if (g_uninit != 0.dd)
        return 5; // all-zero bytes must compare equal to 0
...
int test_decimal_to_chars(void) {
    ...
    if (n != 3 || __builtin_strcmp(buf, "100") != 0)
        return 4;
    return 42;
}
...
int test_decimal_float_h(void) {
    ...
    if (__builtin_strcmp(buf, "0.000000000000001") != 0)
        return 1;
    if (DEC32_MANT_DIG != 7)
        return 2;
...
int test_decimal_math_algebraic(void) {
    if (sqrtd32(9.df) != 3.df)
        return 1;
    if (sqrtd64(4.dd) != 2.dd)
        return 2;
    if (sqrtd128(25.dl) != 5.dl)
        return 3;
    if (cbrtd64(27.dd) != 3.dd)
        return 4;
    if (hypotd64(3.dd, 4.dd) != 5.dd)
        return 5;
    if (fmad64(2.dd, 3.dd, 4.dd) != 10.dd)
        return 6;
    if (fmad128(2.dl, 3.dl, 4.dl) != 10.dl)
        return 7;
    if (fabsd64(-5.dd) != 5.dd)
        return 8;
    if (fabsd128(-5.dl) != 5.dl)
        return 9;
    if (fdimd64(5.dd, 3.dd) != 2.dd)
        return 10;
    if (fdimd64(3.dd, 5.dd) != 0.dd)
        return 11;
    if (fmind64(3.dd, 5.dd) != 3.dd)
        return 12;
    if (fmaxd64(3.dd, 5.dd) != 5.dd)
        return 13;
    return 42;
}
...
int test_decimal_math_exp_log(void) {
    ...
    if (logd64(1.dd) != 0.dd)
        return 2;
    if (log10d64(100.dd) != 2.dd)
        return 3;
    if (log2d64(8.dd) != 3.dd)
        return 4;
    if (exp2d64(3.dd) != 8.dd)
        return 5;
    if (exp10d64(2.dd) != 100.dd)
        return 6;
    if (powd64(2.dd, 10.dd) != 1024.dd)
        return 7;
    if (powd32(2.df, 10.df) != 1024.df)
        return 8;
    if (powd128(2.dl, 10.dl) != 1024.dl)
        return 9;
    if (!approx_eqd64(expd64(1.dd), 2.71828182845905dd, 1e-10dd))
        return 10;
    if (!approx_eqd64(expm1d64(0.dd), 0.dd, 1e-15dd))
        return 11;
    if (!approx_eqd64(log1pd64(0.dd), 0.dd, 1e-15dd))
        return 12;
    return 42;
}
...
int test_decimal_math_trig(void) {
    ...
    if (tand64(0.dd) != 0.dd)
        return 3;
    if (asind64(0.dd) != 0.dd)
        return 4;
    if (atand64(0.dd) != 0.dd)
        return 5;
    if (atan2d64(0.dd, 1.dd) != 0.dd)
        return 6;
    if (!approx_eqd64(sind64(1.dd), 0.841470984807897dd, 1e-9dd))
        return 7;
    if (!approx_eqd64(cosd64(1.dd), 0.540302305868140dd, 1e-9dd))
        return 8;
    return 42;
}
...
int test_decimal_math_hyperbolic(void) {
    if (sinhd64(0.dd) != 0.dd)
        return 1;
    if (coshd64(0.dd) != 1.dd)
        return 2;
    if (tanhd64(0.dd) != 0.dd)
        return 3;
    if (asinhd64(0.dd) != 0.dd)
        return 4;
    if (atanhd64(0.dd) != 0.dd)
        return 5;
    if (!approx_eqd64(sinhd64(1.dd), 1.17520119364380dd, 1e-9dd))
        return 6;
    if (!approx_eqd64(coshd64(1.dd), 1.54308063481524dd, 1e-9dd))
        return 7;
    return 42;
}
...
int test_decimal_math_erf_gamma(void) {
    if (erfd64(0.dd) != 0.dd)
        return 1;
    if (!approx_eqd64(erfcd64(0.dd), 1.dd, 1e-15dd))
        return 2;
    if (!approx_eqd64(tgammad64(5.dd), 24.dd, 1e-9dd))
        return 3; // 4!
    if (!approx_eqd64(lgammad64(1.dd), 0.dd, 1e-9dd))
        return 4;
    return 42;
}
...
int test_decimal_math_rounding(void) {
    if (ceild64(1.1dd) != 2.dd)
        return 1;
    if (ceild64(-1.1dd) != -1.dd)
        return 2;
    if (floord64(1.9dd) != 1.dd)
        return 3;
    if (floord64(-1.1dd) != -2.dd)
        return 4;
    if (truncd64(1.9dd) != 1.dd)
        return 5;
    if (truncd64(-1.9dd) != -1.dd)
        return 6;
    if (roundd64(1.5dd) != 2.dd)
        return 7;
    if (roundd64(-1.5dd) != -2.dd)
        return 8; // ties away from zero
    if (nearbyintd64(2.5dd) != 2.dd)
        return 9; // ties to even (default rounding)
    if (rintd64(1.dd) != 1.dd)
        return 10;
    if (ceild32(1.1df) != 2.df)
        return 11;
    if (ceild128(1.1dl) != 2.dl)
        return 12;
    return 42;
}
...
int test_decimal_math_int_valued(void) {
    if (ilogbd64(100.dd) != 2)
        return 1;
    if (lrintd64(3.dd) != 3)
        return 2;
    if (llrintd64(3.dd) != 3)
        return 3;
    if (lroundd64(1.5dd) != 2)
        return 4;
    if (llroundd64(1.5dd) != 2)
        return 5;
    if (quantexpd64(1.00dd) != -2)
        return 6;
    return 42;
}
...
int test_decimal_math_scale(void) {
    if (scalbnd64(3.dd, 2) != 300.dd)
        return 1;
    if (scalblnd64(3.dd, 2) != 300.dd)
        return 2;
    if (ldexpd64(3.dd, 2) != 300.dd)
        return 3;
    // stepping toward a larger value must move strictly upward
    if (nextafterd64(1.dd, 2.dd) <= 1.dd)
        return 4;
    // stepping toward itself must be a no-op
    if (nextafterd64(1.dd, 1.dd) != 1.dd)
        return 5;
    return 42;
}
...
int test_decimal_math_quantum(void) {
    ...
    if (q != 1.00dd)
        return 1;
    if (!samequantumd64(1.00dd, 2.00dd))
        return 2;
    if (samequantumd64(1.0dd, 1.00dd))
        return 3;
    return 42;
}
...
int test_decimal_math_predicates(void) {
    ...
    if (!isfinited64(1.dd))
        return 5;
    if (isfinited64(infval))
        return 6;
    if (isfinited64(nanval))
        return 7;
    if (!isnormald64(1.dd))
        return 8;
    if (!signbitd64(-1.dd))
    ...
    if (fpclassifyd64(0.dd) != FP_ZERO)
        return 11;
    if (fpclassifyd64(nanval) != FP_NAN)
        return 12;
    if (fpclassifyd64(infval) != FP_INFINITE)
        return 13;
    if (fpclassifyd64(1.dd) != FP_NORMAL)
        return 14;

    if (!isnand32((_Decimal32)nanval))
        return 15;
    if (!isnand128((_Decimal128)nanval))
        return 16;
...
int test_decimal_math_op_coverage(void) {
    if (acosd64(1.dd) != 0.dd)
        return 1;
    if (!approx_eqd64(acoshd64(1.dd), 0.dd, 1e-15dd))
        return 2;
    if (logbd64(100.dd) != 2.dd)
        return 3;
    if (quantumd64(1.00dd) != 0.01dd)
        return 4;

    if (fmodd64(7.dd, 3.dd) != 1.dd)
        return 5;
    if (remainderd64(7.dd, 3.dd) != 1.dd)
        return 6;
    if (copysignd64(3.dd, -1.dd) != -3.dd)
        return 7;
    if (nexttowardd64(1.dd, 2.dl) <= 1.dd)
        return 8;
    if (nexttowardd64(1.dd, 1.dl) != 1.dd)
        return 9;

    if (issignalingd64(1.dd))
        return 10; // a normal value must never signal

    if (!totalorderd64(1.dd, 2.dd))
        return 11;
    if (totalorderd64(2.dd, 1.dd))
        return 12;
...
int test_decimal_printf_widths(void) {
    ...
    if (__builtin_strcmp(buf, "1.500000") != 0)
        return 1;
    snprintf(buf, sizeof buf, "%Df", d);
    if (__builtin_strcmp(buf, "3.300000") != 0)
        return 2;
    snprintf(buf, sizeof buf, "%DDf", l);
    if (__builtin_strcmp(buf, "100.000000") != 0)
        return 3;
    return 42;
}
...
int test_decimal_printf_precision(void) {
    ...
    if (__builtin_strcmp(buf, "3") != 0)
        return 1;
    snprintf(buf, sizeof buf, "%.3Df", d);
    if (__builtin_strcmp(buf, "3.300") != 0)
        return 2;
...
int test_decimal_printf_styles(void) {
    ...
    if (__builtin_strcmp(buf, "3.300000e+00") != 0)
        return 1;
    snprintf(buf, sizeof buf, "%DE", d);
    if (__builtin_strcmp(buf, "3.300000E+00") != 0)
        return 2;
...
int test_decimal_vprintf(void) {
    ...
    if (__builtin_strcmp(out, "[42.500000]") != 0)
        return 1;
    return 42;
}
...
int test_decimal_rounding_modes(void) {
    ...
    if (down != nearest)
        return 2;             // truncating down == nearest here
    if (tozero != down)
        return 3;             // positive operands: to-zero == down
    if (!(up > down))
        return 4;
...
int test_decimal_exception_flags(void) {
    ...
    if (!fetestexcept(FE_DIVBYZERO))
        return 3;
    if (fetestexcept(FE_INEXACT))
        return 4; // divide-by-zero is exact, not inexact
...
int test_decimal_static_fold(void) {
    if (test_decimal_fold_a != 3.3dd)
        return 1;
    if (test_decimal_fold_b != 2.5df)
        return 2;
    if (test_decimal_fold_c != -3.0dl)
        return 3;
    if (test_decimal_fold_d != 3.3)
        return 4;
    if (test_decimal_fold_e != 1)
        return 5;
    if (!isinfd64(test_decimal_fold_inf))
        return 6;
    return 42;
}
...
int test_decimal_inline_binop_operands(void) {
    ...
    _Decimal64 e = 5.0dd, f = 1.0dd, g = 6.0dd,
               h = 4.0dd; // e+f == 6.0, g-h == 2.0
    if (!((e + f) != (g - h)))
        return 3;
    if ((e + f) == (g - h))
        return 4;
...
int test_decimal_operand_chain_pressure(void) {
    _Decimal64 a = 1.0dd, b = 2.0dd, c = 3.0dd, d = 4.0dd, e = 5.0dd, f = 6.0dd;
