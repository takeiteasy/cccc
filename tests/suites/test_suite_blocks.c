...
// Source tests: test_blocks_basic, test_blocks_capture, test_blocks_copy,
// test_blocks_mutable, test_blocks_nested, test_blocks_release_no_stdlib,
...
int test_blocks_capture(void) {
    ...
    int result1 = get_x();
    if (result1 != 10)
        return 1; // Expected: 10, not 20

    // Test 2: Capture multiple variables
    int a                     = 5;
    int b                     = 7;
    int (^add_captured)(void) = ^{
      return a + b;
    };
...
int test_blocks_large_capture(void) {
    ...
    int (^r2)(void)    = ^{
      return t2.a + t2.b + t2.c + t2.d + t2.e;
    };
    if (r2() != 42)
        return 2;
    ...
    t3b.b           = 4;
    int (^r3)(void) = ^{
      return (int)(t3a.a + t3a.b + t3b.a + t3b.b + 32);
    };
    if (r3() != 42)
        return 3;
    ...
    t5.b            = 12;
    int (^r5)(void) = ^{
      return _large_capture_use_bigs(t5);
    };
    if (r5() != 42)
        return 5;
