...
// + one -f pass. Same as test_checked_pointers_prop_nt_fusion_o2.c, one level
// up -- proves #943's propagated CHKNT survives -O3's additional
// fusion/DCE/copy-prop passes too.
