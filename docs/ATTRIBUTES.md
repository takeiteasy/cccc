...
block for several raw preprocessor directives:
...
Inside a `#pragma cccc comptime` region, an emit block can also contain ordinary
C declarations; those declarations are compiled into the runtime translation
unit and copied to generated output.
