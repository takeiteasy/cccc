...
The dominant cost is the interpreter itself; see [BENCHMARKS.md](BENCHMARKS.md) for numbers and [TOOLING.md](TOOLING.md#profiling) for analysis tooling.
