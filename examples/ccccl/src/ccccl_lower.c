/* ccccl_lower.c — form tree -> tree IR (ccccl_ir.h): definitions.
 *
 ...
 * `#include @comptime "ccccl_lower.h"` + on-demand body forwarding. See
 * ccccl_lower.h's file comment for the language surface and scoping model.
 */
#include "ccccl_lower.h"
