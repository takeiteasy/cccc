...
bool emit_indexed_store_if_possible(VirtualMachine *vm, Node *lhs, Type *ty, int value_reg);
...
void add_debug_symbol(VirtualMachine *vm, char *name, long long offset, Type *ty, int is_local, Obj *owner_fn);
void add_label_patch(char *name, Pc patch_location, bool text_relative);
void add_stack_var_meta(VirtualMachine *vm, const char *name, long long offset, Type *ty, int scope_id);
...
void emit_chkab(VirtualMachine *vm, int rs_val, int rs_slo, int rs_shi, bool is_hi);
void emit_chki(VirtualMachine *vm, long long offset);
void emit_chkl(VirtualMachine *vm, long long offset);
void emit_chknt(VirtualMachine *vm, int rs_addr, int rs_hi, int rs_val, long long elem_size);
void emit_chkntz(VirtualMachine *vm, int rs_addr, int rs_hi, int rs_src, long long elem_size);
...
void emit_markp(VirtualMachine *vm, int rs_ptr, int rs_base, int origin_type, size_t size);
...
void emit_sparse_switch_tree(VirtualMachine *vm, SwitchCasePatch *cases, int lo, int hi, int r_val, int r_cmp, PatchList *fail_patches);
...
void gen_wide_bitint_unary(VirtualMachine *vm, Node *node, int dest_reg, const char *helper);
...
void prepare_fp_local_promotion(VirtualMachine *vm, Obj *fn, int base_stack_size);
