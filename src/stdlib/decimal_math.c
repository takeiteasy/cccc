...
static BID_UINT32 load32(const void *p) {
    BID_UINT32 v;
    memcpy(&v, p, 4);
    return v;
}
static BID_UINT64 load64(const void *p) {
    BID_UINT64 v;
    memcpy(&v, p, 8);
    return v;
}
static BID_UINT128 load128(const void *p) {
    BID_UINT128 v;
    memcpy(&v, p, 16);
    return v;
}
static void store32(void *dst, BID_UINT32 v) {
    memcpy(dst, &v, 4);
}
static void store64(void *dst, BID_UINT64 v) {
    memcpy(dst, &v, 8);
}
static void store128(void *dst, BID_UINT128 v) {
    memcpy(dst, &v, 16);
}
...
static void dm_raise_flags(unsigned f) {
    ...
    if (f & DEC_FE_INVALID)
        host |= FE_INVALID;
    if (f & DEC_FE_DIVBYZERO)
        host |= FE_DIVBYZERO;
    if (f & DEC_FE_OVERFLOW)
        host |= FE_OVERFLOW;
    if (f & DEC_FE_UNDERFLOW)
        host |= FE_UNDERFLOW;
    if (f & DEC_FE_INEXACT)
        host |= FE_INEXACT;
    if (host)
...
enum {
    ...
    OP2_NEXTAFTER,
    OP2_COPYSIGN,
    OP2_NEXTTOWARD, // NEXTTOWARD: b is always _Decimal128
};
...
#define MK_MATH1(SFX, BIDT, LD, ST)                                            \
    static long long dec_math1_##SFX(long long op, long long dst,              \
                                     long long a) {                            \
        unsigned f = 0;                                                        \
        ...
        switch (op) {                                                          \
            case OP1_SQRT:                                                     \
                r = __bid##SFX##_sqrt(x, RND, &f);                             \
                break;                                                         \
            case OP1_CBRT:                                                     \
                r = __bid##SFX##_cbrt(x, RND, &f);                             \
                break;                                                         \
            case OP1_EXP:                                                      \
                r = __bid##SFX##_exp(x, RND, &f);                              \
                break;                                                         \
            case OP1_EXP2:                                                     \
                r = __bid##SFX##_exp2(x, RND, &f);                             \
                break;                                                         \
            case OP1_EXP10:                                                    \
                r = __bid##SFX##_exp10(x, RND, &f);                            \
                break;                                                         \
            case OP1_EXPM1:                                                    \
                r = __bid##SFX##_expm1(x, RND, &f);                            \
                break;                                                         \
            case OP1_LOG:                                                      \
                r = __bid##SFX##_log(x, RND, &f);                              \
                break;                                                         \
            case OP1_LOG2:                                                     \
                r = __bid##SFX##_log2(x, RND, &f);                             \
                break;                                                         \
            case OP1_LOG10:                                                    \
                r = __bid##SFX##_log10(x, RND, &f);                            \
                break;                                                         \
            case OP1_LOG1P:                                                    \
                r = __bid##SFX##_log1p(x, RND, &f);                            \
                break;                                                         \
            case OP1_SIN:                                                      \
                r = __bid##SFX##_sin(x, RND, &f);                              \
                break;                                                         \
            case OP1_COS:                                                      \
                r = __bid##SFX##_cos(x, RND, &f);                              \
                break;                                                         \
            case OP1_TAN:                                                      \
                r = __bid##SFX##_tan(x, RND, &f);                              \
                break;                                                         \
            case OP1_ASIN:                                                     \
                r = __bid##SFX##_asin(x, RND, &f);                             \
                break;                                                         \
            case OP1_ACOS:                                                     \
                r = __bid##SFX##_acos(x, RND, &f);                             \
                break;                                                         \
            case OP1_ATAN:                                                     \
                r = __bid##SFX##_atan(x, RND, &f);                             \
                break;                                                         \
            case OP1_SINH:                                                     \
                r = __bid##SFX##_sinh(x, RND, &f);                             \
                break;                                                         \
            case OP1_COSH:                                                     \
                r = __bid##SFX##_cosh(x, RND, &f);                             \
                break;                                                         \
            case OP1_TANH:                                                     \
                r = __bid##SFX##_tanh(x, RND, &f);                             \
                break;                                                         \
            case OP1_ASINH:                                                    \
                r = __bid##SFX##_asinh(x, RND, &f);                            \
                break;                                                         \
            case OP1_ACOSH:                                                    \
                r = __bid##SFX##_acosh(x, RND, &f);                            \
                break;                                                         \
            case OP1_ATANH:                                                    \
                r = __bid##SFX##_atanh(x, RND, &f);                            \
                break;                                                         \
            case OP1_ERF:                                                      \
                r = __bid##SFX##_erf(x, RND, &f);                              \
                break;                                                         \
            case OP1_ERFC:                                                     \
                r = __bid##SFX##_erfc(x, RND, &f);                             \
                break;                                                         \
            case OP1_LGAMMA:                                                   \
                r = __bid##SFX##_lgamma(x, RND, &f);                           \
                break;                                                         \
            case OP1_TGAMMA:                                                   \
                r = __bid##SFX##_tgamma(x, RND, &f);                           \
                break;                                                         \
            case OP1_CEIL:                                                     \
                r = __bid##SFX##_round_integral_positive(x, &f);               \
                break;                                                         \
            case OP1_FLOOR:                                                    \
                r = __bid##SFX##_round_integral_negative(x, &f);               \
                break;                                                         \
            case OP1_TRUNC:                                                    \
                r = __bid##SFX##_round_integral_zero(x, &f);                   \
                break;                                                         \
            case OP1_ROUND:                                                    \
                r = __bid##SFX##_round_integral_nearest_away(x, &f);           \
                break;                                                         \
            case OP1_NEARBYINT:                                                \
                r = __bid##SFX##_round_integral_nearest_even(x, &f);           \
                break;                                                         \
            case OP1_RINT:                                                     \
                r = __bid##SFX##_round_integral_exact(x, RND, &f);             \
                break;                                                         \
            case OP1_LOGB:                                                     \
                r = __bid##SFX##_logb(x, &f);                                  \
                break;                                                         \
            case OP1_QUANTUM:                                                  \
                r = __bid##SFX##_quantum(x, &f);                               \
                break;                                                         \
            case OP1_FABS:                                                     \
                r = __bid##SFX##_abs(x);                                       \
                break;                                                         \
...
long long __cccc_dec_math1(long long op, long long w, long long dst,
                           long long a) {
    switch (w) {
        case 0:
            return dec_math1_32(op, dst, a);
        case 1:
            return dec_math1_64(op, dst, a);
        case 2:
            return dec_math1_128(op, dst, a);
        default:
            return -1;
    }
}
...
#define MK_MATH2(SFX, BIDT, LD, ST)                                            \
    static long long dec_math2_##SFX(long long op, long long dst, long long a, \
                                     long long b) {                            \
        unsigned f = 0;                                                        \
        BIDT     x = LD((const void *)a);                                      \
        BIDT     r;                                                            \
        switch (op) {                                                          \
            case OP2_POW:                                                      \
                r = __bid##SFX##_pow(x, LD((const void *)b), RND, &f);         \
                break;                                                         \
            case OP2_ATAN2:                                                    \
                r = __bid##SFX##_atan2(x, LD((const void *)b), RND, &f);       \
                break;                                                         \
            case OP2_HYPOT:                                                    \
                r = __bid##SFX##_hypot(x, LD((const void *)b), RND, &f);       \
                break;                                                         \
            case OP2_FDIM:                                                     \
                r = __bid##SFX##_fdim(x, LD((const void *)b), RND, &f);        \
                break;                                                         \
            case OP2_QUANTIZE:                                                 \
                r = __bid##SFX##_quantize(x, LD((const void *)b), RND, &f);    \
                break;                                                         \
            case OP2_FMOD:                                                     \
                r = __bid##SFX##_fmod(x, LD((const void *)b), &f);             \
                break;                                                         \
            case OP2_REMAINDER:                                                \
                r = __bid##SFX##_rem(x, LD((const void *)b), &f);              \
                break;                                                         \
            case OP2_FMIN:                                                     \
                r = __bid##SFX##_minnum(x, LD((const void *)b), &f);           \
                break;                                                         \
            case OP2_FMAX:                                                     \
                r = __bid##SFX##_maxnum(x, LD((const void *)b), &f);           \
                break;                                                         \
            case OP2_NEXTAFTER:                                                \
                r = __bid##SFX##_nextafter(x, LD((const void *)b), &f);        \
                break;                                                         \
            case OP2_COPYSIGN:                                                 \
                r = __bid##SFX##_copySign(x, LD((const void *)b));             \
                break;                                                         \
            case OP2_NEXTTOWARD:                                               \
                r = __bid##SFX##_nexttoward(x, load128((const void *)b), &f);  \
                break;                                                         \
            default:                                                           \
                return -1;                                                     \
        }                                                                      \
...
long long __cccc_dec_math2(long long op, long long w, long long dst,
                           long long a, long long b) {
    switch (w) {
        case 0:
            return dec_math2_32(op, dst, a, b);
        case 1:
            return dec_math2_64(op, dst, a, b);
        case 2:
            return dec_math2_128(op, dst, a, b);
        default:
            return -1;
    }
}
...
#define MK_MATH3(SFX, BIDT, LD, ST)                                            \
    static long long dec_math3_##SFX(long long op, long long dst, long long a, \
                                     long long b, long long c) {               \
        unsigned f = 0;                                                        \
        if (op != OP3_FMA)                                                     \
            return -1;                                                         \
        BIDT r = __bid##SFX##_fma(LD((const void *)a), LD((const void *)b),    \
                                  LD((const void *)c), RND, &f);               \
        ST((void *)dst, r);                                                    \
        dm_raise_flags(f);                                                     \
        return 0;                                                              \
    }
...
long long __cccc_dec_math3(long long op, long long w, long long dst,
                           long long a, long long b, long long c) {
    switch (w) {
        case 0:
            return dec_math3_32(op, dst, a, b, c);
        case 1:
            return dec_math3_64(op, dst, a, b, c);
        case 2:
            return dec_math3_128(op, dst, a, b, c);
        default:
            return -1;
    }
}
...
#define MK_MATHI(SFX, BIDT, LD)                                                \
    static long long dec_mathi_##SFX(long long op, long long a, long long b) { \
        ...
        switch (op) {                                                          \
            case OPI_ISNAN:                                                    \
                return __bid##SFX##_isNaN(x);                                  \
            case OPI_ISINF:                                                    \
                return __bid##SFX##_isInf(x);                                  \
            case OPI_ISFINITE:                                                 \
                return __bid##SFX##_isFinite(x);                               \
            case OPI_ISNORMAL:                                                 \
                return __bid##SFX##_isNormal(x);                               \
            case OPI_ISSIGNALING:                                              \
                return __bid##SFX##_isSignaling(x);                            \
            case OPI_SIGNBIT:                                                  \
                return __bid##SFX##_isSigned(x);                               \
            case OPI_FPCLASSIFY:                                               \
                if (__bid##SFX##_isNaN(x))                                     \
                    return CCCC_FP_NAN;                                        \
                if (__bid##SFX##_isInf(x))                                     \
                    return CCCC_FP_INFINITE;                                   \
                if (__bid##SFX##_isZero(x))                                    \
                    return CCCC_FP_ZERO;                                       \
                if (__bid##SFX##_isSubnormal(x))                               \
                    return CCCC_FP_SUBNORMAL;                                  \
                return CCCC_FP_NORMAL;                                         \
            case OPI_ILOGB: {                                                  \
                long long r = __bid##SFX##_ilogb(x, &f);                       \
                dm_raise_flags(f);                                             \
                return r;                                                      \
            }                                                                  \
            case OPI_QUANTEXP: {                                               \
                long long r = __bid##SFX##_quantexp(x, &f);                    \
                dm_raise_flags(f);                                             \
                return r;                                                      \
            }                                                                  \
            case OPI_LRINT: {                                                  \
                long long r = __bid##SFX##_lrint(x, RND, &f);                  \
                dm_raise_flags(f);                                             \
                return r;                                                      \
            }                                                                  \
            case OPI_LLRINT: {                                                 \
                long long r = __bid##SFX##_llrint(x, RND, &f);                 \
                dm_raise_flags(f);                                             \
                return r;                                                      \
            }                                                                  \
            case OPI_LROUND: {                                                 \
                long long r = __bid##SFX##_lround(x, &f);                      \
                dm_raise_flags(f);                                             \
                return r;                                                      \
            }                                                                  \
            case OPI_LLROUND: {                                                \
                long long r = __bid##SFX##_llround(x, &f);                     \
                dm_raise_flags(f);                                             \
                return r;                                                      \
            }                                                                  \
            case OPI_SAMEQUANTUM:                                              \
                return __bid##SFX##_sameQuantum(x, LD((const void *)b));       \
            case OPI_TOTALORDER:                                               \
                return __bid##SFX##_totalOrder(x, LD((const void *)b));        \
            default:                                                           \
                return -1;                                                     \
        }                                                                      \
    }
...
long long __cccc_dec_mathi(long long op, long long w, long long a,
                           long long b) {
    switch (w) {
        case 0:
            return dec_mathi_32(op, a, b);
        case 1:
            return dec_mathi_64(op, a, b);
        case 2:
            return dec_mathi_128(op, a, b);
        default:
            return -1;
    }
}
...
#define MK_MATHN(SFX, BIDT, LD, ST)                                            \
    static long long dec_mathn_##SFX(long long op, long long dst, long long a, \
                                     long long n) {                            \
        unsigned f = 0;                                                        \
        BIDT     x = LD((const void *)a);                                      \
        BIDT     r;                                                            \
        switch (op) {                                                          \
            case OPN_SCALBN:                                                   \
                r = __bid##SFX##_scalbn(x, (int)n, RND, &f);                   \
                break;                                                         \
            case OPN_SCALBLN:                                                  \
                r = __bid##SFX##_scalbln(x, (long)n, RND, &f);                 \
                break;                                                         \
            case OPN_LDEXP:                                                    \
                r = __bid##SFX##_ldexp(x, (int)n, RND, &f);                    \
                break;                                                         \
            default:                                                           \
                return -1;                                                     \
        }                                                                      \
...
long long __cccc_dec_mathn(long long op, long long w, long long dst,
                           long long a, long long n) {
    switch (w) {
        case 0:
            return dec_mathn_32(op, dst, a, n);
        case 1:
            return dec_mathn_64(op, dst, a, n);
        case 2:
            return dec_mathn_128(op, dst, a, n);
        default:
            return -1;
    }
}
...
#define MK_MATHP(SFX, BIDT, LD, ST)                                            \
    static long long dec_mathp_##SFX(long long op, long long dst, long long a, \
                                     long long outp) {                         \
        unsigned f = 0;                                                        \
        BIDT     x = LD((const void *)a);                                      \
        BIDT     r;                                                            \
...
long long __cccc_dec_mathp(long long op, long long w, long long dst,
                           long long a, long long outp) {
    switch (w) {
        case 0:
            return dec_mathp_32(op, dst, a, outp);
        case 1:
            return dec_mathp_64(op, dst, a, outp);
        case 2:
            return dec_mathp_128(op, dst, a, outp);
        default:
            return -1;
    }
}
