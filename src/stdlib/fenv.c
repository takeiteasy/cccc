...
static long long wrap_fegetexceptflag(long long flagp, long long excepts) { return (long long)fegetexceptflag((fexcept_t *)(intptr_t)flagp, (int)excepts); }
static long long wrap_feraiseexcept(long long excepts) { return (long long)feraiseexcept((int)excepts); }
static long long wrap_fesetexceptflag(long long flagp, long long excepts) { return (long long)fesetexceptflag((const fexcept_t *)(intptr_t)flagp, (int)excepts); }
...
static long long wrap_fegetenv(long long envp) { return (long long)fegetenv((fenv_t *)(intptr_t)envp); }
static long long wrap_feholdexcept(long long envp) { return (long long)feholdexcept((fenv_t *)(intptr_t)envp); }
static long long wrap_fesetenv(long long envp) { return (long long)fesetenv(resolve_envp(envp)); }
static long long wrap_feupdateenv(long long envp) { return (long long)feupdateenv(resolve_envp(envp)); }
