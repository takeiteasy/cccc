...
extern void __builtin_ast_add_attribute(VirtualMachine *vm, Obj *fn, const char *attr_text);
extern void __builtin_ast_add_build_target_attr(VirtualMachine *vm, Obj *fn, const char *kind);
...
static void register_reflection_ffi(VirtualMachine *vm) {
    ...
    cc_register_cfunc(vm, "__builtin_ast_add_attribute",
                      (void *)__builtin_ast_add_attribute, 3, 0);
    cc_register_cfunc(vm, "__builtin_ast_add_build_target_attr",
                      (void *)__builtin_ast_add_build_target_attr, 3, 0);
