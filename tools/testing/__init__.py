...
NATIVE_SKIP_TESTS = {
    ...
    # --- #1034 survivors: 3 distinct causes remaining, retagged (8 of the
    ...
    # fixed separately under #1045, and test_comptime_ptr_303.c fixed
    # separately under #1049 -- see #1034's own close comment for what
    # landed and where) ---
