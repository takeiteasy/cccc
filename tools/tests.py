...
All logic lives in tools/testing/. This file exists so that:
  ...
  - Cross-platform targets that pass --binary / --match / --c4 directly still work
...
With --c4, runs the bytecode round-trip: compile each positive test to a
.c4 file and execute it, exercising the cc_save_bytecode / cc_load_bytecode
