...
- **URL includes** — fetch headers directly from URLs with `#include <https://...>`; build with `make JCC_HAS_CURL=1` (optional, requires libcurl)
...
URL includes are an optional feature requiring libcurl: `make JCC_HAS_CURL=1`.
